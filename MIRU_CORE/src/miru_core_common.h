...
namespace miru::base
{
	...
	MIRU_FORWARD_DECLARE_CLASS_AND_REF(Device);
	MIRU_FORWARD_DECLARE_CLASS_AND_REF(Image);
	MIRU_FORWARD_DECLARE_CLASS_AND_REF(ImageView);
	MIRU_FORWARD_DECLARE_CLASS_AND_REF(Instance);
	MIRU_FORWARD_DECLARE_CLASS_AND_REF(Sampler);
	MIRU_FORWARD_DECLARE_CLASS_AND_REF(Pipeline);
	MIRU_FORWARD_DECLARE_CLASS_AND_REF(PhysicalDevice);
	MIRU_FORWARD_DECLARE_CLASS_AND_REF(QueryPool);
