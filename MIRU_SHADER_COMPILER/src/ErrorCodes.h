...
namespace shader_compiler
{
	...
	enum class ErrorCode : uint32_t
	{
		...
		MIRU_SHADER_COMPILER_NO_ENTRY_POINT,
		MIRU_SHADER_COMPILER_NO_SHADER_MODEL,
		MIRU_SHADER_COMPILER_CSO_ERROR,
		MIRU_SHADER_COMPILER_SPV_ERROR,
		MIRU_SHADER_COMPILER_INVALID_RECOMPILE_ARGUMENTS_FILE
	};
	...
	static std::string ErrorCodeToString(int64_t code)
	{
		...
		case ErrorCode::MIRU_SHADER_COMPILER_NO_ENTRY_POINT:
			return "MIRU_SHADER_COMPILER_NO_ENTRY_POINT";
		case ErrorCode::MIRU_SHADER_COMPILER_NO_SHADER_MODEL:
			return "MIRU_SHADER_COMPILER_NO_SHADER_MODEL";
		...
		case ErrorCode::MIRU_SHADER_COMPILER_INVALID_RECOMPILE_ARGUMENTS_FILE:
			return "MIRU_SHADER_COMPILER_INVALID_RECOMPILE_ARGUMENTS_FILE";
		}
	}
