...
namespace d3d12
{
	...
	public:
		...
		struct Features
		{
			...
			D3D12_FEATURE_DATA_D3D12_OPTIONS20														d3d12Options20 = {};
			D3D12_FEATURE_DATA_PREDICATION															predication = {};
			std::vector<std::vector<std::vector<D3D12_FEATURE_DATA_PLACED_RESOURCE_SUPPORT_INFO>>>	placedResourceSupportInfos = {};
			D3D12_FEATURE_DATA_HARDWARE_COPY														hardwareCopy = {};
			D3D12_FEATURE_DATA_D3D12_OPTIONS21														d3d12Options21 = {};
			D3D12_FEATURE_DATA_TIGHT_ALIGNMENT														tightAlignment = {};
			D3D12_FEATURE_DATA_APPLICATION_SPECIFIC_DRIVER_STATE									applicationSpecificDriverState = {};
			D3D12_FEATURE_DATA_BYTECODE_BYPASS_HASH_SUPPORTED										bytecodeBypassHashSupported = {};
			//D3D12_FEATURE_DATA_SHADER_CACHE_ABI_SUPPORT												shaderCacheAbiSupport = {};
			std::vector<std::vector<D3D12_FEATURE_DATA_BARRIER_LAYOUT>>								barrierLayouts = {};
			D3D12_FEATURE_DATA_D3D12_OPTIONS22														d3d12Options22 = {};
