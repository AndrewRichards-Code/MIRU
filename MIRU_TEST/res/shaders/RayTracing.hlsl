...
MIRU_UNIFORM_BUFFER(0, 1, RTShaderConstants, rtShaders);
...
void ray_generation_main()
{
	...
	TraceRay(accelStruct, RAY_FLAG_NONE, 0xFF, rtShaders.HitGroupIndex, rtShaders.NumHitGroups, rtShaders.MissShaderIndex, ray, payload);
